<!-- 歌手 -->
<template>
  <div class=" overflow-scroll h-full flex flex-wrap justify-around py-3 last last:mr-auto ">
    <div @click="toPage(item)" v-for="item in singerList"
      class="group cursor-pointer w-48 h-40 mb-4 flex-col flex items-center">
      <Image class="rounded-full w-28 h-28 group-hover:scale-105 transition-all" :src="item.img1v1Url" :wh="[220, 220]"
        alt="" />
