<!--  -->
<template>
  <div @click="toPage" class="mybox group">
    <div class="relative w-32 h-32">
      <Image :wh="[200, 200]" :src="P.item?.blurPicUrl" alt="" class="image" />
      <div
...
.mybox {
  @apply select-none cursor-pointer  hover:bg-sky-50 hover:shadow-lg transition-all flex w-96 h-36 px-3 m-2 text-center shadow rounded-md items-center;
  ...
  .image {
    @apply rounded-md w-32 h-32 absolute -translate-y-1/2 top-1/2 z-10;
  }
  .info {
    @apply h-4/5 text-left ml-14 flex flex-1 flex-col justify-around overflow-hidden;
  }
}
