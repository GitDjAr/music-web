<template>
  <div class=" items-center justify-center flex group   ">
    ...
    <div class="w-full px-4">
      <TransitionGroup name="fade" tag="div" class=" relative transition-all">
        <div class="w-1/4  ccc relative inline-block overflow-hidden" :key="item.id" v-for="(item) in playlistItems">
...
const hig = reactive<{ playlist: T.MusicPlayList[]; total: number }>({ playlist: [], total: 0 });
