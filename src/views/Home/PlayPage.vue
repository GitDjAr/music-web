<!--  -->
<template>
  <div class='palyPage  overflow-hidden ' v-if="CurPlaySong"
    ...
    <div class="backdrop-filter backdrop-blur-xl w-full h-full flex flex-col ">
      ...
      <div class="pageh overflow-hidden h-full grid  grid-cols-2 items-center  
    md:px-4 xl:px-24 
    ...
    ">
        ...
        <div class="lyricsItem overflow-scroll h-full" style="">
          <ul class="my-10" :style="styleImg">
            <li class=" transition-all text-xl mx-6 py-3 px-6 font-bold  rounded-lg cursor-pointer select-none

              
       text-slate-300" :class="{ 'line': index == active }" v-for="(item, index) in lyrics"
